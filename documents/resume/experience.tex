...
\cventry
  ...
  {
    \begin{cvitems}
      \item{Researching and developing new technologies for DroneHunter}
      \item{Developing software features for DroneHunter}
      \item{Testing features and collecting data for DroneHunter}
      \item{Collaborating and planning development with DroneHunter software team}
    \end{cvitems}
  }
